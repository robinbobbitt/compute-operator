...
//TODO - I think maybe we don't need this at all since only one??
// This controller has a controller loop on clustermanagementaddon.
// If a clustermanagementaddon with the name "kcp-syncer-controller" is created, the
// controller maintains a kcp-syncer addon manager for each workspace.
